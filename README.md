...
Obsidian vault reorganized by academic/application domain. Each topic folder is a self-contained unit holding `chapters/`, `syllabus.md`, and `syllabus.json`.
...
- `Economics/Applied/financial_economics`
- `Economics/Applied/monetary_economics`
- `Economics/Applied/labor_economics`
- `Economics/Applied/public_economics`
- `Economics/Applied/international_economics`
- `Economics/Applied/development_economics`
- `Economics/Applied/industrial_economics`
- `Economics/Applied/urban_and_regional_economics`
...
- `Finance_Capital_Markets/corporate_finance`
...
- `Business_Management/managerial_economics`
- `Business_Management/managerial_accounting`
- `Business_Management/strategic_management`
- `Business_Management/operations_management`
- `Business_Management/project_management`
- `Business_Management/critical_path_method_cpm_earned_value_management_evm`
- `Business_Management/marketing_customer_psychology`
...
- `Energy_Infrastructure_Engineering/energy_conversion_thermodynamics_for_power`
- `Energy_Infrastructure_Engineering/electrical_grid_engineering`
...
- `Law_Governance_Risk/administrative_environmental_law`
- `Law_Governance_Risk/land_rights_easement_law`
...
- `Psychology_Human_Behavior/cognitive_neuroscience`
- `Psychology_Human_Behavior/social_psychology`
- `Psychology_Human_Behavior/organizational_psychology`
- `Psychology_Human_Behavior/positive_psychology_resilience`

## Environmental_Earth_Agricultural_Science

- `Environmental_Earth_Agricultural_Science/earth_science`
...
Topics spanning multiple domains are placed in a single primary home:

| Topic | Primary home | Alt. home(s) |
|---|---|---|
| economics -> energy_economics | Economics/Applied | Energy_Infrastructure_Engineering |
| agriculture_economics | Economics/Applied | Environmental_Earth_Agricultural_Science |
| managerial_economics | Business_Management | Economics |
| law_and_economics | Law_Governance_Risk | Economics |
| publicprivate_partnership_ppp_economics | Energy_Infrastructure_Engineering | Finance_Capital_Markets |
